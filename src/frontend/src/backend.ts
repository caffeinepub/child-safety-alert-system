...
export class Backend implements backendInterface {
    ...
    async clearEmergency(arg0: string): Promise<void> {
    ...
    async getAllChildren(): Promise<Array<Child>> {
        if (this.processError) {
            try {
    ...
    async getChild(arg0: string): Promise<Child> {
        if (this.processError) {
            try {
    ...
    async registerChild(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerChild(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async scanChip(arg0: string): Promise<Child> {
        if (this.processError) {
            try {
                const result = await this.actor.scanChip(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
